...
int speed = 150;                        // 모터 기본 속도(PWM, 0~255)
...
// -----------------------------[ 모터 제어 ]--------------------------------------
void P_forward(float pi) {
  // 전진
  
  left_pwm  = constrain(speed - pi, 0, 255);  // 최소 0, 최대 255
  right_pwm = constrain(speed + pi, 0, 255);  // 최소 0, 최대 255
